...
class SimulationController:
    ...
    def __init__(self):
        if not SimulationController.instance:
            SimulationController.instance = (
                SimulationController.__SimulationController()
            )
    ...
    def run_simulation(self, configurations, run_number=None):
        ...
        source_hash = (
            SimulationController.instance.component_registrar.get_source_hash()
        )
        for configuration in configurations:
            ...
            address = asys.createActor(
                "live_dispatcher.LiveDispatcher", globalName="dispatcher"
            )

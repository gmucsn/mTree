...
class ActorSystemConnector:
    ...
    @staticmethod
    def get_status():
        message = AdminMessage(directive="check_status")
        response = []
        response = ActorSystemController.system_inquiry("SystemStatusActor", message)
        return response
        ...
        #     response = ActorSystemConnector.__instance.actor_system.ask(
    ...
    def run_simulation(mes_base_dir, configuration_filename, run_configuration):
        ...
        simulation_run_id = (
            config_base_name + "-" + nowtime_filename
        )  # str(nowtime).split(".")[0]
    ...
    def run_human_subject_experiment(
        self, mes_base_dir, configuration_filename, run_configuration, subjects
    ):
        ...
        configuration_message = Message()
        configuration_message.set_directive(
            "human_subject_configuration"

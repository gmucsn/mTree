...
@app.command()
def actor_system_startup():
    """
    A method to startup mTree actor system
    """
    ActorSystemController.startup()
    print("Actor system should now have started.")


@app.command()
def actor_system_shutdown():
    """
    A method to shutdown mTree actor system if running
    """
    ActorSystemController.shutdown()
    print("Actor system should now have exited.")


@app.command()
def actor_system_restart():
    """
    A method to restart mTree actor system if running
    """
    ActorSystemController.shutdown()
    print("Actor system should now have exited.")
    ActorSystemController.startup()

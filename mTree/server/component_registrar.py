...
class ComponentRegistrar:
    ...
    def load_components(self):
        ...
        for plugin_file_path in plugin_file_paths:
            ...
            ComponentRegistrar.instance.component_files.append(
        ...
        for component in ComponentRegistrar.instance.component_files:
            ComponentRegistrar.instance.components[component[1]] = (
                ComponentRegistration(component[1], component[0], source_hash)
            )
